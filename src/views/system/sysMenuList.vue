  ...
  <el-main class="menu-page">
    <div class="panel">
      <div class="panel-header">
        ...
        <!-- 新增按钮 -->
        <el-form size="small" class="toolbar">
          <el-form-item>
      ...
      <el-table class="menu-table" size="small" :height="tableHeight" :data="tableList" row-key="menuId"
        :tree-props="{ children: 'children' }" border stripe default-expand-all>
